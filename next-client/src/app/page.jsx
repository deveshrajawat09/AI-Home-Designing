...
import { generatePlan, listPlans, savePlan, deletePlan } from "../lib/api";
import { usePlanStore } from "../lib/store";
import { decodeJwtPayload } from "../lib/authUtils";
...
export default function PlannerView() {
  ...
  const { plan, setPlan, loading, setLoading, error, setError, saved, setSaved, user, token, logout, setToken, setUser } =
    usePlanStore();
