      ...
      <div className="max-w-md w-full space-y-8 p-8 md:p-10 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/60 dark:border-gray-600/40 transition-all">
        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 py-3 px-6 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-emerald-600 via-emerald-500 to-emerald-700 hover:from-emerald-700 hover:via-emerald-600 hover:to-emerald-800 disabled:from-gray-400 disabled:via-gray-500 disabled:to-gray-500 disabled:opacity-60 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-all duration-300 active:scale-95 shadow-lg hover:shadow-2xl hover:shadow-emerald-500/50 disabled:shadow-md btn-elegant"
            onMouseEnter={(e) => !loading && e.target.classList.add('btn-glow-emerald')}
          ...
          <p className="text-center text-sm text-gray-700 dark:text-gray-300">
            ...
            <Link href="/login" className="font-bold text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 transition-colors underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </form>
